                ...
                >
                    {testimonial.map((item) => (
                        <SwiperSlide key={item.id}>
                            <div className="bg-[#fefeff] w-full border h-70 border-amber-600 relative hover:shadow-2xl  rounded-2xl p-7 text-center shadow-lg hover:scale-110 transition  duration-300 ">
