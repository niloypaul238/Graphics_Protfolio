                                ...
                                <div className="flex flex-wrap items-top mb-6">
                                    <div className="w-full lg:w-4/12 px-4 ml-auto">
                                        ...
                                        <ul className="list-unstyled text-gray-600">
                                            <li>
                                                <a className="cursor-pointer hover:text-[#fd6e0a] hover:ml-2 transition-all duration-150  block pb-2 text-sm" >About Us</a>
                                            </li>
                                            <li>
                                    ...
                                    <div className="w-full lg:w-4/12 px-4">
                                        ...
                                        <ul className="list-unstyled text-gray-600">
                                            <li>
                                                <a className="text-blueGray-600 hover:text-[#fd6e0a] cursor-pointer hover:ml-2 transition-all duration-150  block pb-2 text-sm">MIT License</a>
                                            </li>
                                            <li>
                                                <a className="text-blueGray-600 hover:text-[#fd6e0a] cursor-pointer hover:ml-2 transition-all duration-150  block pb-2 text-sm" >Terms &amp; Conditions</a>
                                            </li>
                                            <li>
                                                <a className="text-blueGray-600 hover:text-[#fd6e0a] cursor-pointer hover:ml-2 transition-all duration-150  block pb-2 text-sm" >Privacy Policy</a>
                                            </li>
                                            <li>
                                                <Link href={'/contucts'} className="text-blueGray-600 hover:text-[#fd6e0a] cursor-pointer hover:ml-2 transition-all duration-150  block pb-2 text-sm" >Contact Us</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
